      ...
      <TabsContent value="rules">
        <div className="flex flex-col gap-3">
          <Card><CardHeader><CardTitle>Limites pessoais</CardTitle><CardDescription>Valores prudentes sugeridos, totalmente configuráveis</CardDescription></CardHeader><CardContent><FieldGroup>
            <div className="grid grid-cols-2 gap-3"><PercentRule label="Valor máximo por aposta" value={draft.maxStakePercentage} onSave={(value) => save("maxStakePercentage", value)} /><PercentRule label="Alerta forte" value={draft.strongAlertPercentage} onSave={(value) => save("strongAlertPercentage", value)} /><PercentRule label="Stop diário" value={draft.dailyStopPercentage} onSave={(value) => save("dailyStopPercentage", value)} /><PercentRule label="Stop semanal" value={draft.weeklyStopPercentage} onSave={(value) => save("weeklyStopPercentage", value)} /></div>
          ...
          <Alert className="border-primary/30"><IconShieldCheck className="mb-2 text-primary" /><AlertTitle>Nunca aumentar o valor apostado para recuperar perda.</AlertTitle><AlertDescription>Essa regra é permanente na linguagem e nos alertas do produto.</AlertDescription></Alert>
